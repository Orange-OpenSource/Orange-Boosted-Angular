...
@Component({
  ...
  `<div class="swiper-container">
    ...
    <div *ngIf="pauseButton" class="btn-group" role="group" aria-label="Carousel toggle controls">
      <button type="button" (click)="this.changeState()" id="changeState" class="btn btn-outline-dark btn-sm" [ngClass] = "pauseButton ? 'bottom-swiper':''" [ngClass] = "!this.pause ? 'icon-Pause':'icon-Play'" [attr.aria-label]="!this.pause ? 'set Pause':'set Play'"></button>
    </div>
  </div>`
})
