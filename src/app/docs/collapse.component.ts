...
@Component({
  ...
  template: `
    ...
    <p class="mt-4">Check the <a target="_blank" rel="noopener noreferrer" href="https://ng-bootstrap.github.io/#/components/collapse/examples">ng-bootstrap's original component documentation</a>.</p>
      <h3>Demo</h3>
