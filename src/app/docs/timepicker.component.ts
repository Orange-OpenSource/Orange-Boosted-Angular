...
@Component({
  ...
  template: `
    ...
    href="https://ng-bootstrap.github.io/#/components/timepicker/examples">ng-bootstrap's original component documentation</a>.</p>
        <h3>Demo</h3>
...
export class DocTimepickerComponent {
  public demoSnippets = {
