...
@Component({
  ...
  template: `
    ...
    <p class="mt-4">Check the <a target="_blank" rel="noopener noreferrer" href="https://ng-bootstrap.github.io/#/components/carousel/examples">ng-bootstrap's original component documentation</a>.</p>
        <div class="row">
            <div class="col-md-9">
                <h3>Demo</h3>
