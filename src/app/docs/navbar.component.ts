...
@Component({
  ...
  template: `
    ...
    <p class="mt-4">Check the <a target="_blank" rel="noopener noreferrer" href="https://boosted.orange.com/docs/4.4/components/navbar/">bootsted's original component documentation</a>.</p>
      <h3>Demo</h3>
